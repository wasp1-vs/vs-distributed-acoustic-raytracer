...
% ========================================
\chapter{Themenschwerpunkt: Audio I/O und 3D-Raumdaten}
% ========================================
...
\subsection{WAV-Format: Technische Spezifikation}
...
mit einer festen Abtastrate konfiguriert (Standard: $44.100$\,Hz). Stimmt die
Abtastrate der Eingangs-WAV nicht \"uberein, gibt die Pipeline eine Warnung aus
...
unter 1.0, wird nicht skaliert -- leise Signale werden nicht k\"unstlich lauter.
...
\textbf{Indexierung:} OBJ nutzt 1-basierte Indizes, Python 0-basierte -- der Parser subtrahiert beim Einlesen automatisch 1.
...
\section{Blender-Workflow: Raum erstellen und exportieren}
...
\section{Konfiguration: \texttt{input\_config.json}}
...
% ========================================
\chapter{Visualisierung: \texttt{visualizer.py}}
% ========================================
...
\section{Starten des Visualizers}
...
\section{Materialvergleich: Akustisches Verhalten}
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|c|p{5cm}|}
        ...
        \hline
    \end{tabular}
    \caption{Verhalten verschiedener Materialien (Richtwerte, 12\,m\,$\times$\,12\,m\,$\times$\,10\,m Testraum)}
\end{table}
...
\section{Abschnittsabgrenzung zur DSP-Dokumentation}

Die mathematischen Details der Impulsantwort-Konstruktion (\texttt{build\_impulse\_response}),
die Wahl des Faltungsalgorithmus (\texttt{oaconvolve}) sowie die vollst\"andige
Oktavband-Filterbank sind in Kapitel~5 (Signalverarbeitung, Cem Acar) dokumentiert.
Der vorliegende Abschnitt beschr\"ankt sich auf die Schnittstellenperspektive:
Was \texttt{convolve()} als Vertrag anbietet und wie es in die Gesamtpipeline
eingebunden ist.
