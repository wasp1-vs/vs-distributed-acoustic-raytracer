...
Dieser Abschnitt beschreibt die Implementierung zweier kritischer Komponenten des Distributed Acoustic Ray Tracers:
...
\subsection{Anforderungen (Akzeptanzkriterien)}
...
\subsection{Raumdaten: OBJ-Parser \& Material-Integration}
...
\subsection{Abschnittsabgrenzung zur DSP-Dokumentation}
...
Oktavband-Filterbank sind in Kapitel~7 (Signalverarbeitung, Cem Acar) dokumentiert.
...
\subsection{Implementierte Features}
...
\subsection{Code-Referenz}

\subsection{wav\_handler.py}
Code-Referenz: \texttt{python\_service/wav\_handler.py}

\subsection{obj\_parser.py}
