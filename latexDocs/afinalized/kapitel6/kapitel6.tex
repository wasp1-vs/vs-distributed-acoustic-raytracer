...
In der Implementierung wird eine SOFA-Datei aus der CIPIC-Datenbank \parencite{algazi2001} verwendet, beispielsweise \texttt{subject\_003.sofa}. SOFA ist ein standardisiertes Format für räumliche Audiodaten \parencite{aes69}. Die Klasse \texttt{HRTFDatabase} lädt daraus die Messpositionen und die dazugehörigen HRIRs. HRIR steht für \textit{Head-Related Impulse Response} und bezeichnet die Impulsantworten für linkes und rechtes Ohr zu einer bestimmten Einfallsrichtung.
