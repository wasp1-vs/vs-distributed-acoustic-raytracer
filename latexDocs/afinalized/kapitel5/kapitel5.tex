...
Nach der Sabine'schen Nachhallformel ergibt sich eine analytisch berechnete Nachhallzeit von:
...
Das Profiling der End-to-End-Ausführungszeit deckte einen massiven Engpass bei der Datenserialisierung auf. In einem Stresstest wurde die interne Simulation schnell ausgeführt ($0{,}64\,\text{s}$ Parallel), jedoch dominierte das Schreiben des gigantischen JSON-Datensatzes auf die Festplatte die Gesamtlaufzeit ($>33\,\text{s}$), was die absolute Notwendigkeit eines RAM-gestützten gepufferten Schreibvorgangs (\texttt{BufWriter}) unterstrich.
