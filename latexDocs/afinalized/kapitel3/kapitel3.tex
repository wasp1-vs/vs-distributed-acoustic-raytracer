...
\subsection{Lokale Prozesskopplung zwischen Rust und Python}
\label{subsec:lokale_prozesskopplung}

Neben der verteilten Ausführung auf dem Cluster existiert eine lokale
Prozesskopplung zwischen der Rust-Engine und dem Python-Dienst. Die
Rust-Engine übernimmt die rechenintensive Simulation und exportiert die
berechneten Strahltreffer in die Datei \texttt{ir\_output.json}. Der
Python-Dienst startet die kompilierte Binary, überwacht ihre Ausführung und
übergibt die eingelesenen Ergebnisdaten an die nachgelagerte
Signalverarbeitung.
...
Die dateibasierte Kopplung hält beide Projektteile technisch voneinander
getrennt. Rust bleibt für die performante Berechnung der akustischen Simulation
verantwortlich, während Python die Ausführung koordiniert und die erzeugten
Daten für die weitere Audioverarbeitung bereitstellt. Die konkrete
Implementierung und Fehlerbehandlung dieser Prozessbrücke wird in
Abschnitt~\ref{subsec:rust_runner} beschrieben.
