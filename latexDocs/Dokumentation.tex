...
\begin{document}
    ...
    Abbildung~\ref{fig:reflection-side-view} dargestellt.
    ...
    \begin{tikzpicture}[
        ...
        % Dreiecksfläche in vereinfachter Seitenansicht
        ...
        % Oberflächennormale
        \draw[normal] (0,0) -- (0,3);
        \node[red, right=5pt] at (0,2.35)
        {Normale $\vec{N}$};

        % Einfallender Strahl
        \draw[rayin] (-3,2.2) -- (0,0);
        \node[blue] at (-2.15,1.55)
        {einfallender Strahl};
        \node[blue] at (-1.55,0.95)
        {$\vec{d}$};

        % Reflektierter Strahl
        \draw[rayout] (0,0) -- (3,2.2);
        \node[green!60!black] at (2.15,1.55)
        {reflektierter Strahl};

        % Winkelbögen
        \draw (0,0.75)
        arc[start angle=90, end angle=143.7, radius=0.75];

        \draw (0,0.75)
        arc[start angle=90, end angle=36.3, radius=0.75];
    ...
    \caption{
        Vereinfachte Seitenansicht der Reflexion an einer Dreiecksfläche.
        Einfallswinkel \(\theta_i\) und Reflexionswinkel \(\theta_r\)
        werden relativ zur Oberflächennormalen gemessen und sind gleich groß.
    }
    \label{fig:reflection-side-view}
\end{figure}
